...
- add (QA, Hotfix, Staging) environments

// ui components
- add ui/configuration/config-file 
- add ui/configuration/configuration-sets
- add ui/configuration/configuration-sets-detail
- add ui/configuration/configuration-sets-new
- add ui/configuration/schedule
- add ui/dashboard
- add ui/help
- add ui/login
- add ui/product
...
// shared service
- add shared/service/data
- add shared/service/product

// add MockData (root level)
- add src/MockData
